...
Overlay styles from `@sanity/visual-editing-standalone` are included automatically when visual editing is enabled. You do not need to import the stylesheet yourself.
