...
This is a data fetching composable that wraps `useAsyncData` from Nuxt 4 (see [docs](https://nuxt.com/docs/getting-started/data-fetching#useasyncdata)).
...
::alert{type="info"}
This composable is only available in Nuxt 4. For Bridge, you will need to use `useLazySanityQuery` instead.
::
